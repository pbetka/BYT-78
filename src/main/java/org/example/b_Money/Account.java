...
//			tp.tick(); tp.tick(); //Error double use of tick method
			tp.tick();
		}
	}
...
//		content = content.sub(money);  //Error User could have negative balance on his account
		if (getBalance() >= money.getAmount()) {
			content = content.sub(money);
		}
		else {
			System.err.println("Not enough money on account to withdraw");
		}
	}
	 ...
	 */
//	public Money getBalance() {  //Error wrong return type
	public Integer getBalance() {
//		return content; //Error get amount from balance
