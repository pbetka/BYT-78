...
public class Money {
	...
	public Money add(Money other) {
		Money newMoney = new Money(amount + currency.valueInThisCurrency(other.amount, other.currency), currency);
		return newMoney;
	}
	 ...
	 */
	public Money negate() {
		Money newMoney = new Money(amount * (-1), currency);
		return newMoney;
	}
	...
	public int compareTo(Object other) {
		...
		int universalValue = this.universalValue();
		int otherUniversalValue = otherMoney.universalValue();
		return Integer.compare(universalValue, otherUniversalValue);
	}
}